...
public class SSOServiceSoapImpl implements SSOServiceSoap {

    private static final Logger LOG = Logger.getLogger(SSOServiceSoapImpl.class.getName());
